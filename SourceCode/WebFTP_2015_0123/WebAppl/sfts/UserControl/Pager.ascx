<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Pager.ascx.cs" Inherits="WebAppl.sfts.UserControl.Pager" %>
<div align="center" id="table_pager" runat="server">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;共<asp:Label ID="lbl_pagecount" runat="server"></asp:Label>
    &nbsp;頁&nbsp;，共&nbsp;<asp:Label ID="lbl_datacount" runat="server"></asp:Label>&nbsp;筆
